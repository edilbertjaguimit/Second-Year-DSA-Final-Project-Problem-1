...
while index < SIZE:
  ...
  if choose == '1':
    ...
    if ctr == index:
      ...
      ITEM_DESCRIPTION[0] = input("Enter Item Description : ").upper()
  ...
  # Insert Item at the End
    ...
    while ctr < index:
      ...
      ctr += 1
    if flag:
      ITEM_CODE[index] = itemCode
      ITEM_DESCRIPTION[index] = input("Enter Item Description : ").upper()
    ...
    if position >= SIZE or position < 0:
      ...
      if position < index+1:
        ...
        while ctr < index:
          ...
          ctr += 1
        if ctr == index:
          ITEM_CODE[position] = itemCode
          ITEM_DESCRIPTION[position] = input("Enter Item Description : ").upper()
  ...
  # Update Item by Code
    ...
    if index == 0:
      ...
      while ctr < index:
        if itemCode == ITEM_CODE[ctr]:
          ITEM_DESCRIPTION[ctr] = input("Enter New Description : ").upper()
