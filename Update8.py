...
while index < SIZE:
  ...
  # Update Item by Code
    ...
    if index == 0:
      ...
      # newItemDescription = input("Enter New Description : ")
      # newItemPrice = input("Enter New Price : ")
      # newItemQuantity = input("Enter New Quantity : ")
      # newItemCategory = input("Enter New Category : ")
      found = False
      ctr = 0
      while ctr < index:
        if itemCode == ITEM_CODE[ctr]:
          ITEM_DESCRIPTION[ctr] = input("Enter New Description : ")
          ITEM_PRICE[ctr] = input("Enter New Price : ")
          ITEM_QUANTITY[ctr] = input("Enter New Quantity : ")
  ...
  # Display All
    ...
    if index == 0:
      ...
      print("Overall Total : ", overAllTotal)
