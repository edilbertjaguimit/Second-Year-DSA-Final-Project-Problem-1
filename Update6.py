...
while index < SIZE:
    ...
    if index == 0:
      ...
      while ctr < index:
        if searchItemCode == ITEM_CODE[ctr]:
          print(ITEM_CODE[ctr], ITEM_DESCRIPTION[ctr], ITEM_PRICE[ctr], ITEM_QUANTITY[ctr], ITEM_CATEGORY[ctr])
          found = False
          break
        ctr += 1
      if found:
  ...
  # elif choose == '13
    ...
    if index == 0:
      ...
      oldItemCode = input("Enter Old Item Code to Update : ")
      newItemCode = input("Enter New Item Code to Update : ")
      i = 0
      exist = True
      while i < index:
        if newItemCode == ITEM_CODE[i]:
          print("Item Code Already Exist.")
          exist = False
          break
        else:
      ...
      if exist:
        ...
        ctr = 0
        while ctr < index:
          if oldItemCode == ITEM_CODE[ctr]:
            ITEM_CODE[ctr] = newItemCode
            found = True
            break
          ctr += 1
        if found:
